        ...
        <div class="relative" x-data="{ notifOpen: false }">
            <button @click="notifOpen = !notifOpen" class="relative p-2 text-gray-300 hover:text-white transition focus:outline-none">
                ...
                @if(isset($unreadCount) && $unreadCount > 0)
                    <span class="absolute -top-1 -right-1 flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-red-600 px-1 text-[10px] font-bold text-white border-2 border-gray-800">
            ...
            <div x-show="notifOpen" 
                ...
                <div class="px-4 py-2 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <a href="#" class="text-xs text-blue-500 hover:text-blue-700">Tandai Semua Dibaca</a>
                </div>

                <div class="max-h-64 overflow-y-auto">
                    @forelse($notifications ?? [] as $notif)
                        <a href="{{ $notif->url ?? '#' }}" class="block px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition {{ $notif->is_read ? '' : 'bg-blue-50' }}">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 bg-blue-100 rounded-full p-2 text-blue-600 mr-3">
                ...
                <div class="border-t border-gray-100 pt-1">
                    <a href="#" class="block text-center px-4 py-2 text-xs font-bold text-gray-600 hover:bg-gray-50 hover:text-blue-600 transition">
